	...
	<div class="container">
		<div class="row head">
			...
			<div class="col-md-4 align text-right my-auto">
				<a href="php/create.php"><button class="btn btn-success btn-sm">Add New Inventory</button></a>
			</div>
		</div>
		<div class="row">
			<div class="col-md-12">
				<form action="create.php" method="POST">
					...
					<div class="form-group">
						...
						<input class="form-control" name="jumlahbarang" type="text">
					</div>
					<div class="form-group">
						<label>Kategori Barang:</label>
						<input class="form-control" name="kategoribarang" type="text">
					</div>
